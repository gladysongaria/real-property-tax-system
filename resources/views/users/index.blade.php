                            ...
                            <h4>Add User</h4>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Firstname">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                             <div class="form-group">
                                            <label for="exampleInputEmail1"><strong>Office</strong></label>
                                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Office">
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Role">
                                    </div>
                                </div>
                            </div>
                                <br>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @if(Auth::user()->user_role === 'Super_Admin')
                                                ...
                                                <button class="btn btn-danger btn-sm"  data-bs-toggle="modal" data-bs-target="#delete{{$user->id}}">
